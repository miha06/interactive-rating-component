...
//the classname represents for each element helps in settings such as the text color, size, line spacing, etc. 
...
function App() {
  ...
  <>
	...
	<p className="text-gray-400 mb-100">Please let us know how we did with your support request. All feedback is appreciated 
	...
	const ThankYou =({items, setIsSubmitted}) => {
		return (
			...
			<div className="flex items-center justify-center">
				...
				<p className="text-gray-400 mb-100 text-center">We appreciate you taking the time to give a rating. If you ever need more support, 
